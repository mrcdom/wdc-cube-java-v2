# br.com.wdc.shopping.persistence.client
...
```mermaid
graph TD
    pkg["br.com.wdc.shopping.persistence.client"]
...
| **Javalin** (`backend`) | Registra `RestAuthenticationService` para propagação de auth |
