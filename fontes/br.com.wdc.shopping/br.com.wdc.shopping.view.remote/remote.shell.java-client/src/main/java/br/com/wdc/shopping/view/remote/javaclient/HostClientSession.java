...
import br.com.wdc.shopping.view.remote.javaclient.model.ViewStateMap;
import br.com.wdc.shopping.view.remote.javaclient.model.ViewStateSnapshot;
...
final class HostClientSession implements AutoCloseable {
    ...
    private HostResponse parse(String json) {
        ...
        // Parse activeViews (informational only — server sends full list periodically)
        // No action needed: our ViewStateMap is authoritative for the client side.
