 ...
 * @author Shai Almog
 */
public class ShoppingCn1RemoteAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "WDC Shopping (CN1)";
    private static final String APP_NAME = "ShoppingCn1RemoteApp";
    ...
    private ShoppingCn1RemoteApp mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ShoppingCn1RemoteAppStub());
    }
        ...
        Display.getInstance().callSerially(new Runnable() {
            ...
            public void run() {
                if(Display.getInstance().isEdt()) {
                    mainApp = new ShoppingCn1RemoteApp();
                    mainApp.init(this);
                    mainApp.start();
