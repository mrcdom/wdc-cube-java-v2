...
React build artifacts (generated by Parcel in `react.client`) are packaged in the stub JAR's `META-INF/resources/` folder and automatically served as static files. 
...
Core dependencies:
- `react.skeleton` - View implementations, security, WebSocket SPI
