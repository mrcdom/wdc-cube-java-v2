...
React build artifacts (generated by Parcel in `remote.react`) are packaged in the stub JAR's `META-INF/resources/` folder and automatically served as static files. 
