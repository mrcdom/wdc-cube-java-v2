...
React build artifacts (generated by Parcel in `remote.shell.react`) are packaged in the stub JAR's `META-INF/resources/` folder and automatically served as static files. 
...
Core dependencies:
- `remote.host` - View implementations, security, WebSocket SPI
