...
React build artifacts (generated by Parcel in `frontend.react`) are packaged in the stub JAR's `META-INF/resources/` folder and automatically served as static files. 
...
Core dependencies:
- `remote.skeleton` - View implementations, security, WebSocket SPI
